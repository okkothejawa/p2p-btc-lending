...
pub enum Contract {
    ...
    /// Inital state where a contract is being proposed for a loan.
    OfferedLoan(offered_contract::OfferedLoanContract),
    /// Offered loan contract with escrow confirmed.
    OfferedLoanEscrowConfirmed(offered_contract::OfferedLoanContract),
...
impl std::fmt::Debug for Contract {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let state = match self {
            ...
            Contract::OfferedLoan(_) => "offered loan",
            Contract::OfferedLoanEscrowConfirmed(_) => "offered loan escrow confirmed",
...
impl Contract {
    ...
    pub fn get_id(&self) -> ContractId {
        match self {
            ...
            Contract::OfferedLoan(o) | Contract::OfferedLoanEscrowConfirmed(o) => o.offered_contract.id,
    ...
    pub fn get_counter_party_id(&self) -> PublicKey {
        match self {
            ...
            Contract::OfferedLoan(o) | Contract::OfferedLoanEscrowConfirmed(o) => o.offered_contract.counter_party,
