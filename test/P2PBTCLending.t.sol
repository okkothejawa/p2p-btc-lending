...
//     bytes public constant BTC_ADDRESS = hex"ac3475fd92345189361f2992a0995d9bb66725b1";
...
//         // Create borrow request
//         lending.requestBorrow(3001, 1, BTC_ADDRESS, SIGNED_PSBT);

//         // Lender address
//         address lender = address(0x2);

//         // Lend to borrower
//         lending.lend(borrower, P2PBTCLending.TransactionParams({
//             version: bytes4(hex"02000000"),
//             vin: hex"027b54103055b42effbbee6cc7e8a9e5f417dc211b740dee430d40286cfe4e2c1d0000000000ffffffff620eb0ca10141d1b4babe98a0a6cbafd35ccae2487bc68d2487a476c419311fd0100000000fdffffff",
//             vout: hex"02b90b000000000000160014ac3475fd92345189361f2992a0995d9bb66725b1e009000000000000160014178f633dc01c5cbff8ca4a707521a863f191ed39",
//             locktime: bytes4(0),
//             intermediateNodes: hex"00000000",
//             blockHeight: 0,
//             index: 0
//         }), hex"00000000");
...
//         //     uint256 interestRate,
//         //     bool active
//         // ) = lending.loans(lender, borrower);

//         // assertEq(amount, BORROW_AMOUNT, "Incorrect loan amount");
//         // assertEq(interestRate, INTEREST_RATE, "Incorrect interest rate");
